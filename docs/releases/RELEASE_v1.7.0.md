...
sed -i 's/version   = "dev"/version   = "1.7.0"/' cmd/daemon/main.go
...
- ✅ **Reliability**: Reproducible builds with deterministic binaries
...
- **Reproducible Builds**: Verified deterministic builds via CI check (Go 1.24)
