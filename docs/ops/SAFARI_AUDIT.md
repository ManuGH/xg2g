...
- Script: `apps/webui/scripts/no-ua-sniffing.mjs`
- Fails on `navigator.userAgent/platform/vendor/appVersion` in runtime `apps/webui/src/**`.
...
- Contract test: `apps/webui/tests/contracts/v3player.mode-bridge.test.ts`.
