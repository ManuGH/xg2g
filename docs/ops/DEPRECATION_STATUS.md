...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `XG2G_STREAM_PORT` | `XG2G_E2_STREAM_PORT` (or `enigma2.streamPort`) | fail-start | v3.5.0 | `internal/config/guardrail.go` | `docs/deprecations.json`, `docs/DEPRECATION_POLICY.md` |
