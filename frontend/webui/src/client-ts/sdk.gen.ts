 ...
 */
export const getErrors = <ThrowOnError extends boolean = false>(options?: Options<GetErrorsData, ThrowOnError>) => (options?.client ?? client).get<GetErrorsResponses, unknown, ThrowOnError>({
 ...
 */
export const getHouseholdProfiles = <ThrowOnError extends boolean = false>(options?: Options<GetHouseholdProfilesData, ThrowOnError>) => (options?.client ?? client).get<GetHouseholdProfilesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postHouseholdProfiles = <ThrowOnError extends boolean = false>(options: Options<PostHouseholdProfilesData, ThrowOnError>) => (options.client ?? client).post<PostHouseholdProfilesResponses, PostHouseholdProfilesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/household/profiles',
    ...options,
    headers: {
 ...
 */
export const deleteHouseholdUnlock = <ThrowOnError extends boolean = false>(options?: Options<DeleteHouseholdUnlockData, ThrowOnError>) => (options?.client ?? client).delete<DeleteHouseholdUnlockResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getHouseholdUnlock = <ThrowOnError extends boolean = false>(options?: Options<GetHouseholdUnlockData, ThrowOnError>) => (options?.client ?? client).get<GetHouseholdUnlockResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/household/unlock',
    ...options
});
 ...
 */
export const postHouseholdUnlock = <ThrowOnError extends boolean = false>(options: Options<PostHouseholdUnlockData, ThrowOnError>) => (options.client ?? client).post<PostHouseholdUnlockResponses, PostHouseholdUnlockErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/household/unlock',
    ...options,
    headers: {
 ...
 */
export const deleteHouseholdProfile = <ThrowOnError extends boolean = false>(options: Options<DeleteHouseholdProfileData, ThrowOnError>) => (options.client ?? client).delete<DeleteHouseholdProfileResponses, DeleteHouseholdProfileErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const putHouseholdProfile = <ThrowOnError extends boolean = false>(options: Options<PutHouseholdProfileData, ThrowOnError>) => (options.client ?? client).put<PutHouseholdProfileResponses, PutHouseholdProfileErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/household/profiles/{profileId}',
    ...options,
    headers: {
 ...
 */
export const getSystemEntitlements = <ThrowOnError extends boolean = false>(options?: Options<GetSystemEntitlementsData, ThrowOnError>) => (options?.client ?? client).get<GetSystemEntitlementsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postSystemEntitlementReceipt = <ThrowOnError extends boolean = false>(options: Options<PostSystemEntitlementReceiptData, ThrowOnError>) => (options.client ?? client).post<PostSystemEntitlementReceiptResponses, PostSystemEntitlementReceiptErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postSystemEntitlementOverride = <ThrowOnError extends boolean = false>(options: Options<PostSystemEntitlementOverrideData, ThrowOnError>) => (options.client ?? client).post<PostSystemEntitlementOverrideResponses, PostSystemEntitlementOverrideErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const deleteSystemEntitlementOverride = <ThrowOnError extends boolean = false>(options: Options<DeleteSystemEntitlementOverrideData, ThrowOnError>) => (options.client ?? client).delete<DeleteSystemEntitlementOverrideResponses, DeleteSystemEntitlementOverrideErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postRecordingPlaybackInfo = <ThrowOnError extends boolean = false>(options: Options<PostRecordingPlaybackInfoData, ThrowOnError>) => (options.client ?? client).post<PostRecordingPlaybackInfoResponses, PostRecordingPlaybackInfoErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/recordings/{recordingId}/stream-info',
    ...options,
    headers: {
 ...
 * Renew session lease
 */
export const postSessionHeartbeat = <ThrowOnError extends boolean = false>(options: Options<PostSessionHeartbeatData, ThrowOnError>) => (options.client ?? client).post<PostSessionHeartbeatResponses, PostSessionHeartbeatErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
