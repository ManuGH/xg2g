...
struct VideoGeometryTests {
    ...
    func testActiveFormatDescriptionSEIParsing() {
        ...
        let atscSEI = Data([0x04, 0x09, 0xB5, 0x00, 0x31, 0x47, 0x41, 0x39, 0x34, 0x41, 0x49])
        ...
        let dvbSEI = Data([0x04, 0x07, 0x00, 0x44, 0x54, 0x47, 0x31, 0x01, 0x4A])
        ...
        let unflaggedSEI = Data([0x04, 0x09, 0xB5, 0x00, 0x31, 0x47, 0x41, 0x39, 0x34, 0x41, 0x09]) // 0x09 has bit 6 == 0
        ...
        let ccSEI = Data([0x04, 0x09, 0xB5, 0x00, 0x31, 0x43, 0x43, 0x30, 0x31, 0x41, 0x49])
