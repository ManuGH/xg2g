...
#if !os(iOS)
public enum UIImpactFeedbackGenerator {
    public enum FeedbackStyle: Sendable {
        case light, medium, heavy, soft, rigid
    }
}
public enum UINotificationFeedbackGenerator {
    public enum FeedbackType: Sendable {
        case success, warning, error
    }
}
public enum UISelectionFeedbackGenerator {
}
#endif
...
public final class Haptics {
    ...
    public func impact(_ style: UIImpactFeedbackGenerator.FeedbackStyle = .light) {}
    public func selection() {}
    public func notification(_ type: UINotificationFeedbackGenerator.FeedbackType = .success) {}
    #endif
}
