...
public final class H264AccessUnitAssembler: @unchecked Sendable {
    ...
    /// Discards any partially-assembled NAL units or pending Access Unit slices
    /// following a Transport Stream packet loss or continuity error.
    /// Preserves parameter sets (SPS/PPS) and decoder format description.
