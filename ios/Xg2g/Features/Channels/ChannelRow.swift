...
#if DEBUG
struct ChannelRowPreviewItem: Identifiable, Sendable {
    let id: String
    let channel: Channel
    let nowNext: NowNext?
...
@available(iOS 26.0, *)
#Preview("Channel Variations", arguments: [
    ChannelRowPreviewItem(
        id: "ard_live",
        channel: GuidePreviewData.channel("1", "Das Erste HD"),
        nowNext: NowNext(
            serviceRef: "1:0:19:1:0:0:0:0:0:0:",
            now: GuidePreviewData.entry("Tagesschau", startingMinutesFromNow: -10, lasting: 15),
            next: GuidePreviewData.entry("Tatort: Der schwarze Troll", startingMinutesFromNow: 5, lasting: 90)
        ),
        timeFilter: .now,
        isFavorite: true
    ),
    ChannelRowPreviewItem(
        id: "zdf_prime",
        channel: GuidePreviewData.channel("2", "ZDF HD"),
        nowNext: NowNext(
            serviceRef: "1:0:19:2:0:0:0:0:0:0:",
            now: GuidePreviewData.entry("heute journal", startingMinutesFromNow: -20, lasting: 30),
            next: GuidePreviewData.entry("auslandsjournal", startingMinutesFromNow: 10, lasting: 30)
        ),
        timeFilter: .now,
        isFavorite: false
    ),
    ChannelRowPreviewItem(
        id: "sky_sports",
        channel: GuidePreviewData.channel("201", "Sky Sport Top Event"),
        nowNext: NowNext(
            serviceRef: "1:0:19:201:0:0:0:0:0:0:",
            now: GuidePreviewData.entry("UEFA Champions League Live", startingMinutesFromNow: -45, lasting: 120),
            next: nil
        ),
        timeFilter: .primeTimeTonight,
        isFavorite: true
    ),
    ChannelRowPreviewItem(
        id: "no_epg",
        channel: GuidePreviewData.channel("99", "Lokal TV"),
        nowNext: nil,
        timeFilter: .now,
        isFavorite: false
    )
