...
For a persistent Linux installation, clone or download the repository and run:
...
access, DVR rewind window, storage, and GPU. It generates the secrets and uses
the same pinned systemd/Compose deployment contract as manual upgrades. It
