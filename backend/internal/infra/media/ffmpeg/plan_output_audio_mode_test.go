...
func TestAppendLiveAudioArgsSupportsPlannerAudioOnlyTranscode(t *testing.T) {
	...
	require.Equal(t,
		[]string{"-c:a", "aac", "-b:a", "160k", "-ac", "2", "-ar", "48000", "-af", "aformat=sample_fmts=s16p,aresample=async=1", "-sn"},
...
func TestAppendLiveAudioArgsPreservesLegacyCouplingWhenModeUnset(t *testing.T) {
	...
	require.Equal(t,
		[]string{"-c:a", "aac", "-b:a", "320k", "-ac", "2", "-ar", "48000", "-af", "aformat=sample_fmts=s16p,aresample=async=1", "-sn"},
