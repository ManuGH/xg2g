...
func TestAppendLiveAudioArgsSupportsPlannerAudioOnlyTranscode(t *testing.T) {
	...
	require.Equal(t,
		[]string{"-c:a", "aac", "-b:a", "160k", "-ac", "2", "-ar", "48000", "-af", "aresample=async=1,aformat=channel_layouts=stereo", "-cutoff", "20000", "-sn"},
...
func TestAppendLiveAudioArgsPreservesLegacyCouplingWhenModeUnset(t *testing.T) {
	...
	require.Equal(t,
		[]string{"-c:a", "aac", "-b:a", "320k", "-ac", "2", "-ar", "48000", "-af", "aresample=async=1,aformat=channel_layouts=stereo", "-cutoff", "20000", "-sn"},
