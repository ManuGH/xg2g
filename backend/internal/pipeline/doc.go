...
// Package pipeline implements the Control Plane and Orchestration Layer.
//
// Overview:
// The pipeline architecture introduces a stateful, event-driven model for managing streams,
...
//
// Usage:
// The pipeline system is enabled by default (see `XG2G_ENGINE_ENABLED=true`).
