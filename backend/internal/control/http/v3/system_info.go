...
func (s *Server) GetSystemInfo(w http.ResponseWriter, r *http.Request) {
	...
	resp := SystemInfoData{
		Hardware: HardwareInfo{
			Brand:              optionalStringPtr(info.Info.Brand),
			Model:              optionalStringPtr(info.Info.Model),
			Boxtype:            optionalStringPtr(info.Info.Boxtype),
			Chipset:            optionalStringPtr(info.Info.Chipset),
			ChipsetDescription: optionalStringPtr(info.Info.FriendlyChipsetText),
		},
		Software: SoftwareInfo{
			OeVersion:     optionalStringPtr(info.Info.OEVer),
			ImageDistro:   optionalStringPtr(orElse(info.Info.FriendlyImageDistro, info.Info.ImageDistro)),
			ImageVersion:  optionalStringPtr(info.Info.ImageVer),
			EnigmaVersion: optionalStringPtr(info.Info.EnigmaVer),
			KernelVersion: optionalStringPtr(info.Info.KernelVer),
			DriverDate:    optionalStringPtr(info.Info.DriverDate),
			WebifVersion:  optionalStringPtr(info.Info.WebIFVer),
		},
