...
const (
	...
	CodeTokenMissing             = "TOKEN_MISSING"       // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenMalformed           = "TOKEN_MALFORMED"     // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenInvalidAlg          = "TOKEN_INVALID_ALG"   // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenInvalidSig          = "TOKEN_INVALID_SIG"   // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenExpired             = "TOKEN_EXPIRED"       // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenNotActive           = "TOKEN_NOT_ACTIVE"    // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenMissingClaim        = "TOKEN_MISSING_CLAIM" // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenIssMismatch         = "TOKEN_ISS_MISMATCH"  // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenAudMismatch         = "TOKEN_AUD_MISMATCH"  // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenSubMismatch         = "TOKEN_SUB_MISMATCH"  // #nosec G101 -- public problem-code identifier, not a credential.
	CodeTokenModeMismatch        = "TOKEN_MODE_MISMATCH" // #nosec G101 -- public problem-code identifier, not a credential.
