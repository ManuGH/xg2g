...
func TestKnownRuntimeEnvKeys_IncludesDirectReadEnvKeys(t *testing.T) {
	...
	want := []string{
		...
		"XG2G_STREAMRELAY_CACHED_ANALYZE_DURATION", "XG2G_STREAMRELAY_CACHED_PROBE_SIZE", "XG2G_LIVE_USER_AGENT",
		"XG2G_EXPERIMENTAL_CMAF_SEGMENTER",
		"XG2G_INGEST_FFLAGS", "XG2G_LIVE_ANALYZE_DURATION", "XG2G_LIVE_PROBE_SIZE",
