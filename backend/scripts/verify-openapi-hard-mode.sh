...
consumption_first_line="$(head -n 1 frontend/webui/src/types/api/consumption.d.ts || true)"
if [[ "$consumption_first_line" != "$consumption_marker" ]]; then
  echo "❌ Missing generated marker: frontend/webui/src/types/api/consumption.d.ts"
  exit 1
fi
